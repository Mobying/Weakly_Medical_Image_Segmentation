...
def vis_segmentation(image, seg_map):
    ...
    ax = plt.gca()
    print(type(ax))
    ax.yaxis.set_tricks_position('right')
...
# LABEL_NAMES = np.asarray(['background', 'person', 'test']) # 假设只有两类
...
imgfile = 'PNG2/preprocessed/Transverse/t1ce/101.png'
pngfile = 'PNG2/preprocessed/Transverse/truth/101.png'
